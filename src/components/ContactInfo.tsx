...
const ContactInfo: React.FC = () => {
  return (
    ...
    >
      <a href="mailto:nooziproductions@gmail.com" className="flex items-center gap-3 text-tango/70 hover:text-tango transition-colors duration-200 cursor-pointer">
      ...
      <a href="tel:+919495885632" className="flex items-center gap-3 text-tango/70 hover:text-tango transition-colors duration-200 cursor-pointer">
        <div className="p-2 rounded-lg bg-beta/10 border border-beta/20">
          <Phone className="w-4 h-4 text-beta" />
        </div>
        <span className="font-poppins text-sm">+91 94958 85632</span>
      </a>
